...
(function ($) { // Hide scope, no $ conflict
    ...
    $.extend(Countdown.prototype, {
        ...
        _resetExtraLabels: function (base, options) {
            ...
            if (changingLabels) {
                for (var k in base) { // Remove custom numbered labels
                    if (k.match(/[Ll]abels[0-9]/)) {
                        base[k] = null;
                    }
                }
            }
        ...
        _generateHTML: function (inst) {
            ...
            for (var period2 = S; period2 >= Y; period2--) { // Determine significant periods
                if (inst._show[period2]) {
                    if (inst._periods[period2]) {
                        showSignificant[period2] = true;
                    }
                    else {
                        showSignificant[period2] = sigCount > 0;
                        sigCount--;
                    }
                }
            }
        ...
        _calculatePeriods: function (inst, show, significant, now) {
            ...
            if (significant) { // Zero out insignificant periods
                for (var period2 = Y; period2 <= S; period2++) {
                    if (significant && periods[period2]) {
                        significant--;
                    }
                    else if (!significant) {
                        periods[period2] = 0;
